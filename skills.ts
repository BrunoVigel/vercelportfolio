export const SkillCard = [
  ...
  },
  {
    ...
    image: {
      source: "/images/styled-components.png",
      alt: "Logo Wordpress",
    },
  },
  {
    title: "Chakra UI",
    definition:
      "Chakra UI é uma biblioteca de componentes do React que facilita a construção da IU de um aplicativo ou site. Seu objetivo é fornecer um conjunto de componentes simples, modular e acessível para começar a funcionar rapidamente.",
    image: {
      source: "/images/svgs/chakra.svg",
      alt: "Logo Chakra",
    },
  },
  {
    title: "Jest",
    definition:
      "Jest é uma estrutura de teste JavaScript construída em cima do Jasmine e mantida pela Meta. Ele foi projetado e construído por Christoph Nakazawa com foco na simplicidade e suporte para grandes aplicativos da web.",
    image: {
      source:
